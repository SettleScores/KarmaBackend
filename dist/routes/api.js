...
karmaRouter.get(Paths_1.default.Karma.Tasks, authenticateToken_1.authenticate, KarmaRoutes_1.default.getTasks);
karmaRouter.post(Paths_1.default.Karma.UploadFile, [authenticateToken_1.authenticate, (0, prepareFileUploader_1.prepareLoader)()], KarmaRoutes_1.default.uploadFile);
karmaRouter.post(Paths_1.default.Karma.CreepInTask, authenticateToken_1.authenticate, KarmaRoutes_1.default.creepInTask);
karmaRouter.get(Paths_1.default.Karma.User, authenticateToken_1.authenticate, KarmaRoutes_1.default.getUserProfile);
karmaRouter.post(Paths_1.default.Karma.Push, authenticateToken_1.authenticate, KarmaRoutes_1.default.pushPush);
karmaRouter.post(Paths_1.default.Karma.PushToken, authenticateToken_1.authenticate, KarmaRoutes_1.default.pushToken);
karmaRouter.post(Paths_1.default.Karma.PushForAll, authenticateToken_1.authenticate, KarmaRoutes_1.default.pushPushForAll);
