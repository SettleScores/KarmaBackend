...
exports.default = {
    ...
    Postgresql: {
        Username: ((_j = process.env.USER_NAME) !== null && _j !== void 0 ? _j : ''),
        Password: ((_k = process.env.PASSWORD) !== null && _k !== void 0 ? _k : ''),
        Dbserver: ((_l = process.env.DBSERVER) !== null && _l !== void 0 ? _l : ''),
        Database: ((_m = process.env.DATABASE) !== null && _m !== void 0 ? _m : ''),
    },
    Firebase: {
        PrivateKeyPath: ((_o = process.env.PRIVATE_KEY_PATH) !== null && _o !== void 0 ? _o : ''),
    },
};
